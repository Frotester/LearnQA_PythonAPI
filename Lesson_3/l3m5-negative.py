...
class TestUserAuth:
    def test_auth_user(self):
        ...
        print("MYDEBUG", user_id_from_auth_method, user_id_from_check_method)
        assert user_id_from_auth_method == user_id_from_check_method, "User id from auth method is not equal to user id from from check method"
