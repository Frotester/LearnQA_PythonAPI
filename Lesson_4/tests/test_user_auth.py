...
#  python -m pytest --alluredir=Lesson_4/test_results Lesson_4/tests/test_user_auth.py
...
class TestUserAuth(BaseCase):
    ...
    @allure.description("This test authorize successfully user by email and password")
